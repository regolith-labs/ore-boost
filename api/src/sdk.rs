...
// Build migrate_config instruction.
pub fn migrate_config(signer: Pubkey) -> Instruction {
    let config_address = config_pda().0;
    Instruction {
        program_id: crate::ID,
        accounts: vec![
            ...
            AccountMeta::new(config_address, false),
            AccountMeta::new_readonly(ore_api::consts::MINT_ADDRESS, false),
            AccountMeta::new(proof_pda(config_address).0, false),
            AccountMeta::new(
