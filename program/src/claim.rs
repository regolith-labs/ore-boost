...
pub fn process_claim(accounts: &[AccountInfo<'_>], data: &[u8]) -> ProgramResult {
    ...
    // Load accounts
    let clock = Clock::get()?;
    let [signer_info, beneficiary_info, boost_info, config_info, config_tokens_info, reserve_info, reserve_tokens_info, stake_info, treasury_info, treasury_tokens_info, token_program] =
        accounts
    else {
