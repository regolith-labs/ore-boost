...
use solana_program::{address_lookup_table, program::invoke_signed};
use steel::*;
...
pub fn process_create_stake_lookup_table(
    ...
    // Load accounts.
    let [signer_info, stake_lookup_table_info, lookup_table_info, boost_info, system_program, lookup_table_program, slot_hash] =
        accounts
    else {
